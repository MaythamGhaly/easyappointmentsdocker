...
$lang['customer_details_title'] = 'Detalls del patient';
$lang['service'] = 'Servei';
...
$lang['manage_customers_hint'] = 'Gestiona els patients registrats i mostra el seu historial de reserves.';
...
$lang['hide'] = 'Amaga';
$lang['type_to_filter_customers'] = 'Tecleja per filtrar els patients.';
$lang['clear_fields_add_existing_customer_hint'] = 'Buida els camps i entra un nou patient.';
$lang['pick_existing_customer_hint'] = 'Escull un patient existent.';
...
$lang['edit_working_plan_hint'] = 'Marqueu a sota els dies i les hores en que la vostra organització acceptarà cites. Podreu ajustar les cites a les hores no laborables, però els patients no podran reservar cites en aquests períodes. Aquesta planificació de treball serà utilitzada per defecte per cada nou proveïdor, però podreu canviar cadascuna de les planificacions dels proveïdors de forma separada. Finalment, podeu afegir períodes de pausa.';
...
$lang['book_advance_timeout_hint'] = 'Defineix el temps límit (en minuts) a partir del qual els patients no poden reservar una hora o modificar una cita.';
$lang['timeout_minutes'] = 'Temps límit de reserva (minuts)';
$lang['about_app_info'] = 'Easy!Appointments és una aplicació web molt ajustable que permet als vostres patients reservar cites amb vosaltres a través del web. A més, us permet sincronitzar amb Google Calendar de manera que ho podeu usar amb altres serveis.';
...
$lang['delete_customer'] = 'Elimina un patient';
...
$lang['require_captcha_hint'] = 'Quan s\'habilita, els patients hauran de teclejar una cadena CAPTCHA generada aleatòriament abans de reservar o actualitzar una cita.';
...
$lang['customer_notifications'] = 'Notificacions als patients';
$lang['customer_notifications_hint'] = 'Defineix si el patient rebrà notificacions per correu electrònic quan hi hagi un canvi en la planificació de les seves cites.';
...
$lang['require_phone_number_hint'] = 'Quan està activat, els patients i els usuaris hauran d\'introduir el número de telèfon al reservar una cita';
...
$lang['display_any_provider_hint'] = 'La pàgina de reserva mostrarà una opció addicional que permet als patients reservar sense especificar un proveïdor.';
...
$lang['disable_booking_hint'] = 'La pàgina de reserva de cites es desactivarà mentre aquest paràmetre estigui actiu i els patients no podran realitzar noves cites.';
...
$lang['theme'] = 'Tema';
$lang['limit_customer_access'] = 'Limita l\'accés als patients';
$lang['limit_customer_access_hint'] = 'Si s\'activa, els proveïdors i els secretaris només tindran accés als patients amb els que tenen cites.';
$lang['url'] = 'URL';
...
$lang['customer_save'] = 'Desa el patient';
$lang['customer_delete'] = 'Elimina el patient';
...
$lang['webhooks_info'] = 'Els Webhooks us permeten enviar notificacions HTTP a aplicacions web externes com a resposta a diversos esdeveniments com la creació d\'una cita o l\'eliminació d\'un patient.';
...
$lang['future_booking_limit_hint'] = 'Estableix el límit en dies per avançat en el que es permet als patients demanar cites..';
...
$lang['customer_is_already_booked'] = 'Aquest patient ja té una cita en el període de reserva sol·licitat.';
$lang['fields'] = 'Camps';
