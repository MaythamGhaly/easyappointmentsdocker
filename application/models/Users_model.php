...
class Users_model extends EA_Model
{
    ...
    public function search(string $keyword, int $limit = null, int $offset = null, string $order_by = null): array
    {
        $users = $this->db
            ...
            ->or_like('custom_field_1', $keyword)
            ->or_like('custom_field_2', $keyword)
            ->or_like('custom_field_3', $keyword)
            ->or_like('custom_field_4', $keyword)
            ->or_like('custom_field_5', $keyword)
