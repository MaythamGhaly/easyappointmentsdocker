...
<div class="container-fluid backend-page" id="calendar-page">
    <div class="row" id="calendar-toolbar">
        <div id="calendar-filter" class="col-md-3 p-3">
        ...
        <div class="d-flex flex-column col-md-7 justify-content-center align-items-center text-light">
            <!-- <h4 class="text-light">Export</h4> -->
            <div  class="export-section border p-3 border-danger rounded-3 justify-content-center d-flex align-items-center gap-2">
                ...
                <button class="btn btn-light text-light" id="export" style="background:#d55353;">Export</button>
            </div>
            <p class="text-danger d-none" id="error-mes">Please Enter a dates</p>
        </div>
        <div id="calendar-actions" class="col-md-2 p-3">
            ...
            <?php if (can('add', PRIV_APPOINTMENTS)): ?>
                <div class="dropdown d-sm-inline-block">
                    <a class="btn btn-light" href="#" id="insert-appointment" type="button" data-bs-toggle="dropdown">
...
<?php section('scripts'); ?>
<script src="<?= asset_url('assets/js/components/calendar_modal.js') ?>"></script>
