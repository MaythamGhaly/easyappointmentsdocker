                    ...
                    <div class="row">
                        <div class="details col-12 col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" class="form-control" max="512" disabled>
                            </div>
                        ...
                        <div class="settings col-12 col-md-6">
                            ...
                            <!-- <div class="mb-3">
                                ...
                                <select id="calendar-view" class="form-select" disabled>
                            ...
                            <!-- <div class="mb-3">
                                ...
                                <?php //component('timezone_dropdown', [
                                    //'attributes' => 'id="timezone" class="form-control" disabled',
